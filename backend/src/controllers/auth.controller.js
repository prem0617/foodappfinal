    ...
    return __generator(this, function (_b) {
      switch (_b.label) {
        case 0:
          ...
          return [
            4 /*yield*/,
            user_model_1.default.findOne({ username: lowerusername }),
          ];
        case 1:
          ...
          return [
            4 /*yield*/,
            bcrypt_1.default.compare(password, isUserExists.password),
          ];
        case 2:
          ...
          token = (0, geterateTokenAndSetCookies_1.geterateTokenAndSetCookies)(
            req,
            res,
            userId.toString()
          );
